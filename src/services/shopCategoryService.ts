...
export const ShopCategoryService = {
   ...
   */
  getShopCategories: async (params?: {
    page?: number;
    size?: number;
    search?: string;
  }): Promise<{
    content: ShopCategoryDTO[];
  ...
  getShopCategoryById: async (id: number): Promise<ShopCategoryDTO> => {
    return handleApiCall(() =>
      api.get(config.endpoints.admin.shopCategory(id)),
    );
  },
  ...
  deleteShopCategory: async (id: number): Promise<void> => {
    return handleApiCall(() =>
      api.delete(config.endpoints.admin.shopCategory(id)),
    );
  },
   ...
   */
  getShopSubCategoriesPaginated: async (params?: {
    page?: number;
    size?: number;
    search?: string;
  }): Promise<{
    content: ShopSubCategoryDTO[];
    totalElements: number;
    totalPages: number;
  }> => {
   ...
   */
  getShopSubCategoriesByCategory: async (
    categoryId: number,
  ): Promise<ShopSubCategoryDTO[]> => {
  ...
  getShopSubCategoryById: async (id: number): Promise<ShopSubCategoryDTO> => {
    return handleApiCall(() =>
      api.get(config.endpoints.admin.shopSubCategory(id)),
    );
  },
   ...
   */
  createShopSubCategory: async (
    categoryId: number,
    data: FormData,
  ): Promise<ShopSubCategoryDTO> => {
    return handleApiCall(() =>
      api.post(
        config.endpoints.admin.shopSubCategoriesByCategory(categoryId),
        data,
      ),
    );
  },
  ...
  deleteShopSubCategory: async (id: number): Promise<void> => {
    return handleApiCall(() =>
      api.delete(config.endpoints.admin.shopSubCategory(id)),
    );
  },
};
