...
export default function UserShopReports() {
    ...
    const handleResolve = async () => {
        ...
        try {
            await moderationService.updateUserShopReportStatus(resolveReport.id, "RESOLVED");
    ...
    const handleDismiss = async (id: string) => {
        try {
            await moderationService.updateUserShopReportStatus(id, "DISMISSED");
    ...
    return (
        <div className="flex flex-col gap-6">
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="text-base">User and Shop Reports</CardTitle>
                </CardHeader>
