...
export default function ManageRegions() {
    ...
    const handleDelete = async () => {
        if (!deleteId) return;
        try {
            await regionService.deleteRegion(deleteId);
        ...
        <div className="container mx-auto py-6 space-y-6">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    ...
                    <p className="text-muted-foreground">Manage and organize geographical regions for shops.</p>
                </div>
                                ...
                                {loading ? (
                                    ...
                                    regions.map((region) => (
                                        <TableRow 
                                            ...
                                            onClick={() => navigate(`/regions/edit/${region.id}`)}
                                        >
                                            <TableCell>
                                            ...
                                            <TableCell className="text-right" onClick={(e) => e.stopPropagation()}>
                                                <DropdownMenu>
                                                    ...
                                                    <DropdownMenuContent align="end">
                                                        ...
                                                        <DropdownMenuSeparator />
                                                        <DropdownMenuItem onClick={(e) => { e.stopPropagation(); navigate(`/regions/edit/${region.id}`); }}>
                                                        ...
                                                        <DropdownMenuItem
                                                            ...
                                                            onClick={(e) => { e.stopPropagation(); setDeleteId(region.id); }}
                                                        >
            ...
            <ConfirmDialog
                ...
                title="Delete Region?"
                description="This action cannot be undone. This will permanently delete the region from our servers."
                confirmText="Delete"
                cancelText="Cancel"
                variant="destructive"
