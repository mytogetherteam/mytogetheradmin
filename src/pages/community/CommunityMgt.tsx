...
import { EyeOff, Pencil, Plus, Search, Trash2, User, Users } from "lucide-react";
        ...
        <div className="flex flex-col gap-6">
            <div className="flex items-center justify-between gap-3">
                <div className="flex items-center gap-3">
                    ...
                    <h1 className="text-lg font-semibold md:text-2xl">Social Posts</h1>
                </div>
                <Button onClick={() => navigate("/community/posts/create")}>
                                                        ...
                                                        <Tooltip>
                                                            <TooltipTrigger asChild>
                                                                <Button
                                                                    size="sm"
                                                                    variant="ghost"
                                                                    onClick={() => navigate(`/community/posts/${p.id}/edit`)}
                                                                >
